    ...
    <div class="contents information information-detail">
        ...
        <form id="frmEstimate" name="frmEstimate" method="post" action="/information/estimate_step04_insert">
        ...
        <div class="form">
            ...
            <div class="input-area js-input">
              <div class="input">
                <label>취급상품</label>
                <input type="text" id="goods_title" name="goods_title" placeholder="Ex) 반찬, 샐러드, 육류, 의류 등">
          ...
          <div class="input-area js-input number">
            <div class="input mbtn10">
              ...
              <input type="text" id="goods_length" name="goods_length" placeholder="가로 x 세로 x 높이 (세변의 합)" maxlength="5">
              <button type="button" class="btn-clear"><span><span class="blind">입력 텍스트 삭제</span></span></button>
            </div>
            <div class="input">
              <input type="text" id="goods_weight" name="goods_weight" placeholder="무게" maxlength="4">
              <button type="button" class="btn-clear"><span><span class="blind">입력 텍스트 삭제</span></span></button>
            </div>
        </div>

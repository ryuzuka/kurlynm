    ...
    <div class="contents information information-detail">
        ...
        <form id="frmEstimate" name="frmEstimate" method="post" action="/information/estimate_step02_update">
                ...
                <div class="round-box">
                  <div class="form-box">
                    <div class="form-cell select-date">
                      ...
                      <input type="hidden" id="release_date" name="release_date" value="<?=$estimate->release_date?>">
                      <div class="input-group">
                        <div class="inbox">
                          <div class="year dropdown js-dropdown" data-placeholder="<?=substr($estimate->release_date,0,4)?>">
                            <button type="button" id="startYear" class="dropdown-btn" aria-haspopup="listbox" aria-expanded="false"></button>
                        ...
                        <div class="inbox">
                          <div class="month dropdown js-dropdown" data-placeholder="<?=substr($estimate->release_date,5,2)?>">
                        ...
                        <div class="inbox">
                          <div class="date dropdown js-dropdown" data-placeholder="<?=substr($estimate->release_date,8,2)?>">
                    ...
                    <?php
                        $arrWeek = explode(",", $estimate->release_week);
                    ?>
                    <div class="form-cell">
                      <div class="form-head">
                        <em>출고요일</em>
                        <span>*픽업일 기준 (복수 선택 가능)</span>
                        <input type="hidden" id="release_week" name="release_week" value="<?=$estimate->release_week?>">
                      </div>
                      <div class="input-group">
                            <div class="chk-box">
                            <input type="checkbox" id="release_week_1" name="release_weeks" value="월" class="release_week" <?php if(in_array("월", $arrWeek)) { echo "checked"; } ?>><label for="release_week_1">월</label>
                          </div>
                          <div class="chk-box">
                            <input type="checkbox" id="release_week_2" name="release_weeks" value="화" class="release_week" <?php if(in_array("화", $arrWeek)) { echo "checked"; } ?>><label for="release_week_2">화</label>
                          </div>
                          <div class="chk-box">
                            <input type="checkbox" id="release_week_3" name="release_weeks" value="수" class="release_week" <?php if(in_array("수", $arrWeek)) { echo "checked"; } ?>><label for="release_week_3">수</label>
                          </div>
                          <div class="chk-box">
                            <input type="checkbox" id="release_week_4" name="release_weeks" value="목" class="release_week" <?php if(in_array("목", $arrWeek)) { echo "checked"; } ?>><label for="release_week_4">목</label>
                          </div>
                          <div class="chk-box">
                            <input type="checkbox" id="release_week_5" name="release_weeks" value="금" class="release_week" <?php if(in_array("금", $arrWeek)) { echo "checked"; } ?>><label for="release_week_5">금</label>
                          </div>
                          <div class="chk-box">
                            <input type="checkbox" id="release_week_6" name="release_weeks" value="토" class="release_week" <?php if(in_array("토", $arrWeek)) { echo "checked"; } ?>><label for="release_week_6">토</label>
                          </div>
                          <div class="chk-box">
                            <input type="checkbox" id="release_week_7" name="release_weeks" value="일" class="release_week" <?php if(in_array("일", $arrWeek)) { echo "checked"; } ?>><label for="release_week_7">일</label>
                          </div>
                      </div>
                    </div>
                    ...
                    <div class="form-cell">
                      <div class="form-head">
                        ...
                        <input type="hidden" id="release_method" name="release_method" value="<?=$estimate->release_method?>">
                      </div>
                      <div class="input-group">
                        <div class="rdo-box">
                          <input type="radio" id="release_method_1" name="sel_release_method" class="release_method" value="P" <?php if($estimate->release_method == "P") { echo "checked"; } ?>><label for="release_method_1">픽업요청</label>
                        </div>
                        <div class="rdo-box">
                          <input type="radio" id="release_method_2" name="sel_release_method" class="release_method" value="S" <?php if($estimate->release_method == "S") { echo "checked"; } ?>><label for="release_method_2">자체입고</label>
                        </div>
                      </div>
                    </div>
                    <div class="pickup-details">
                      <div class="form-cell">
                        <div class="form-head">
                          ...
                          <input type="hidden" id="release_time" name="release_time" value="<?=$estimate->release_time?>">
                        </div>
                        <div class="input-group type">
                          <div class="inbox">
                            <div class="dropdown js-dropdown" data-placeholder="<?=substr($estimate->release_time,0,2)?>">
                          ...
                          <div class="inbox">
                            <div class="dropdown js-dropdown" data-placeholder="<?=substr($estimate->release_time,3,2)?>">
                      ...
                      <div class="form-cell">
                        <div class="form-head">
                            ...
                            <input type="hidden" id="pickup_time" name="pickup_time" value="<?=$estimate->pickup_time?>">
                        </div>
                        <div class="input-group type">
                          <div class="inbox">
                            <div class="dropdown js-dropdown" data-placeholder="<?=substr($estimate->pickup_time,0,2)?>">
                          ...
                          <div class="inbox">
                            <div class="dropdown js-dropdown" data-placeholder="<?=substr($estimate->pickup_time,3,2)?>">
                              <button type="button" class="dropdown-btn" aria-haspopup="listbox" aria-expanded="false">분</button>
                              <div class="dropdown-box">
                                <ul class="dropdown-list" role="listbox" aria-labelledby="dropdown" tabindex="-1">
                                    <?php for($i=0; $i<=50; $i=$i+10) { ?>
                  ...
                  <div class="address full js-postcode">
                    <div class="input-area js-input">
                        ...
                        <div class="input mbtn result">
                            <input type="text" id="pickup_address1" name="pickup_address1" value="<?=$estimate->pickup_address1?>">
                          <button type="button" class="btn-search"><span><span class="blind">입력 텍스트 삭제</span></span></button>
                        </div>
                        <div class="input mbtn detail">
                          <input type="text" id="pickup_address2" name="pickup_address2" title="상세 주소 입력" placeholder="상세주소를 입력해주세요." value="<?=$estimate->pickup_address2?>">
                      ...
                      <div class="form-cell">
                        <div class="form-head">
                          <label>픽업 상차유형</label>
                          <input type="hidden" id="pickup_type" name="pickup_type" value="<?=$estimate->pickup_type?>">
                      </div>
                        <div class="input-group mbtn10">
                            <div class="chk-box">
                              <input type="checkbox" id="release_method_1" name="sel_release_type" class="pickup_type" value="B" <?php if($estimate->pickup_type == "B") { echo "checked"; } ?>><label for="release_method_1">박스</label>
                            </div>
                            <div class="chk-box">
                              <input type="checkbox" id="release_method_2" name="sel_release_type" class="pickup_type" value="P" <?php if($estimate->pickup_type == "P") { echo "checked"; } ?>><label for="release_method_2">파레트</label>
                            </div>
                            <div class="chk-box">
                              <input type="checkbox" id="release_method_3" name="sel_release_type" class="pickup_type" value="R" <?php if($estimate->pickup_type == "R") { echo "checked"; } ?>><label for="release_method_3">롤테이너</label>
                            </div>                            
                        </div>
                        <div class="input-area js-input">
                          <div class="input mbtn">
                            <input type="text" id="pickup_etc" name="pickup_etc" title="기타 유형 입력" placeholder="기타 : 유형을 입력해주세요." value="<?=$estimate->pickup_etc?>">
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="form-cell full">
                      ...
                      <textarea  id="release_content" name="release_content" cols="10" rows="3" placeholder="제품 또는 픽업 기사님께서 인지하여야 할 특이사항을 자세하게 입력해주세요."><?=$estimate->release_content?></textarea>
                    </div>
                  </div>
                </div>
...
<script>
    $(function() {
        var pickup = "<?=$estimate->release_method?>"

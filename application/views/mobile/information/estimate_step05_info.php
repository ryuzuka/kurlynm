    ...
    <div class="contents information information-detail">
        ...
        <form id="frmEstimate" name="frmEstimate" method="post" action="/information/estimate_step05_update">
        ...
        <div class="form">
            ...
            <div class="input-area js-input">
              <div class="input">
                ...
                <input type="text" id="manager_name" name="manager_name" placeholder="담당자 성함을 입력해주세요." value="<?=$estimate->manager_name?>">
          ...
          <div class="input-area js-input">
            <div class="input">
              ...
              <input type="number" id="manager_tel" name="manager_tel" placeholder="'-' 없이 숫자만 입력해주세요." value="<?=$estimate->manager_tel?>">
              <button type="button" class="btn-clear"><span><span class="blind">입력 텍스트 삭제</span></span></button>
            </div>
        </div>
        ...
        <div class="input-area js-input">
          <div class="input">
            ...
            <input type="email" id="manager_email" name="manager_email" placeholder="담당자 이메일 주소를 입력해주세요." value="<?=$estimate->manager_email?>">
            <button type="button" class="btn-clear"><span><span class="blind">입력 텍스트 삭제</span></span></button>
          </div>
       </div>

                    ...
                    <div class="box">
                        <ul>
                            ...
                            <li class="end">
                                ...
                                <input type="password" id="question_passwd" name="question_passwd" placeholder="숫자/영문 포함 8자리 이상">
                            </li>
                            <li>
                                ...
                                <div class="file">
                                    <div class="btn_are">
                                        ...
                                        <div class="file_info file_info_1">
                                            ...
                                            <span class='sel_file sel_file_1' data-idx="1" style="display: none;"></span>
                                        </div>
                                        <div class="file_info file_info_2">
                                            <label class="btn btn-secondary btn_file_2" for="file2">파일첨부</label>
                                            <span class='sel_file sel_file_2' data-idx="2"  style="display: none;"></span>
                                        </div>
                                        <div class="file_info file_info_3">
                                            <label class="btn btn-secondary btn_file_3" for="file3">파일첨부</label>
                                            <span class='sel_file sel_file_3' data-idx="3"  style="display: none;"></span>
                                        </div>

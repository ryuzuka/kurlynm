...
<html lang="ko">
  ...
  <body>
    ...
    <div class="slide_top">
        ...
        ?>        
        <div>
            <a href="/customer/event_info?seq=<?=$list->seq?>">
                <div class="linebanner">
                  <p><?=$list->banner_title?></p>
                </div>
            </a>
        </div>
        <?php } ?>
    ...
    <div class="wrap main">
        ...
        <!-- Header -->
        <?php $this->load->view('mobile/include/header'); ?>
  ...
  <script type="text/javascript" src="/mo/js/main.js"></script>
  <!-- components -->
  <script>
	  ;($ => {

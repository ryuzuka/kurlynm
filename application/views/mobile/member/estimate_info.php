      ...
      <div class="estimate_detail">
        ...
        <div class="box">
            <ul>
                ...
                <li>
                    ...
                    <p class="info"><?=$estimate->release_week?></p>
                </li>
                <li>
        ...
        <div class="box">
            ...
            <div class="box_flex">
                ...
                <div class="in_content">
                    <div class="info left">
                        <p>월</p>
                        <div class="count"><?=number_format($estimate->early_day1_cnt)?><span>건</span></div>

                    </div>
                    <div class="info right">
                        <p class="p18">화</p>
                        <div class="count"><?=number_format($estimate->early_day2_cnt)?><span>건</span></div>

                    </div>
                    <div class="info left">
                        <p>수</p>
                        <div class="count"><?=number_format($estimate->early_day3_cnt)?><span>건</span></div>

                    </div>
                    <div class="info right">
                        <p class="p18">목</p>
                        <div class="count"><?=number_format($estimate->early_day4_cnt)?><span>건</span></div>

                    </div>
                    <div class="info left">
                        <p>금</p>
                        <div class="count"><?=number_format($estimate->early_day5_cnt)?><span>건</span></div>

                    </div>
                    <div class="info right end">
                        <p class="p18">토</p>
                        <div class="count"><?=number_format($estimate->early_day6_cnt)?><span>건</span></div>
                    </div>
                    <div class="info left">
                        <p>일</p>
                        <div class="count"><?=number_format($estimate->early_day7_cnt)?><span>건</span></div>

                    </div>
                </div>

            </div>
            <div class="box_flex end">
                <p class="title">월별</p>
                <div class="in_content">
                    <div class="info w100">
                        <p><?=$estimate->early_month1?>월</p>
                        <div class="count"><?=number_format($estimate->early_month1_cnt)?><span>건</span></div>
                    </div>
                    <div class="info w100">
                        <p><?=$estimate->early_month2?>월</p>
                        <div class="count"><?=number_format($estimate->early_month2_cnt)?><span>건</span></div>
                    </div>
                    <div class="info w100 end">
                        <p><?=$estimate->early_month3?>월</p>
                        <div class="count"><?=number_format($estimate->early_month3_cnt)?><span>건</span></div>
                    </div>
        ...
        <div class="box">
            <div class="box_flex end">
                ...
                <div class="in_content">
                    <div class="info w100">
                        <p><?=$estimate->delivery_month1?>월</p>
                        <div class="count"><?=number_format($estimate->delivery_month1_cnt)?><span>건</span></div>
                    </div>
                    <div class="info w100">
                        <p><?=$estimate->delivery_month2?>월</p>
                        <div class="count"><?=number_format($estimate->delivery_month2_cnt)?><span>건</span></div>
                    </div>
                    <div class="info w100 end">
                        <p><?=$estimate->delivery_month3?>월</p>
                        <div class="count"><?=number_format($estimate->delivery_month3_cnt)?><span>건</span></div>
                    </div>
                </div>
            </div>
        </div>

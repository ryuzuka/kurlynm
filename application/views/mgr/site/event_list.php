                    ...
                    <td>
                        <div class="col-xs-2">
                            <select name="s_status" id="s_status" class="form-control input-sm">
                                ...
                                <option value="W"<?php if($s_status == "W") echo " selected"; ?>>진행대기</option>
                                <option value="I"<?php if($s_status == "I") echo " selected"; ?>>진행중</option>
                                <option value="E"<?php if($s_status == "E") echo " selected"; ?>>진행종료</option>
                            </select>
                        </div>
                    </td>
                </tr>
            ...
            <div class="box">
                    ...
                    <table id="member-list" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr <?=$style_value?>>
                                ...
                                <td><a href="/mgr/site/event_info?seq=<?=$list->seq?>&<?=$params?>"><?=$list->title?></a></td>
                            ...
                            ?>
                            <tr>
                                <td colspan="5" class="text-center" style="vertical-align:middle;">등록된 데이터가 없습니다.</td>
                            </tr>
                            <?php
                            }
                            ?>
                ...
                <div style="margin:10px 0;">
                    ...
                    <div class="col-xs-6 text-right">
                        <a href="/mgr/site/event_insert?<?=$params?>" class="btn btn-primary btn-sm" style="width:80px;">등록</a>
                    </div>
                </div>
            </div>
        </div>

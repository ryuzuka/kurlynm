            ...
            <form id="frm" name="frm" method="post" action="/mgr/site/dashboard_action" class="form-horizontal" role="form" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input type="text" id="release_count" name="release_count" maxlength="3" class="form-control input-sm onlynum" value="<?php if($mode == "update") echo $dashboard->release_count; ?>" onkeypress="javascript:onlyNumber();">
                        </div>
                    </div>

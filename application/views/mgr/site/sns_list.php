            ...
            <div class="box">
                    ...
                    <table id="member-list" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr <?=$style_value?>>
                                ...
                                <td><?=$list->sns_name?></td>
                                <td><a href="/mgr/site/sns_info?seq=<?=$list->seq?>&<?=$params?>"><?=$list->title?></a></td>
                ...
                <div style="margin:10px 0;">
                    ...
                    <div class="col-xs-6 text-right">
                        <a href="/mgr/site/sns_insert?<?=$params?>" class="btn btn-primary btn-sm" style="width:80px;">등록</a>
                    </div>
                </div>
            </div>
        </div>

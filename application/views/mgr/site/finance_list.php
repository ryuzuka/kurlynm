            ...
            <div class="box">
                    ...
                    <table id="member-list" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="/mgr/site/finance_info?seq=<?=$list->seq?>"><?=$list->title?></a></td>
                                <td class="text-center">
                                    <?php if($list->file_name) { ?>
                                    <a href="<?=$list->file_path?>/<?=$list->file_name?>"><?=$list->file_name?></a>
                                    <?php } else { ?>
                                    N/A
                                    <?php } ?>
                                </td>
                ...
                <div style="margin:10px 0;">
                    ...
                    <div class="col-xs-6 text-right">
                        <a href="/mgr/site/finance_insert" class="btn btn-primary btn-sm" style="width:80px;">등록</a>
                    </div>
                </div>
            </div>
        </div>

            ...
            <div class="box">
                    ...
                    <table id="member-list" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr <?=$style_value?>>
                                ...
                                <td><a href="/mgr/site/popup_info?seq=<?=$list->seq?>&<?=$params?>"><?=$list->title?></a></td>
                                <td><?=date('Y-m-d', strtotime($list->start_date))?></td>
                                <td><?=date('Y-m-d', strtotime($list->end_date))?></td>                                
                                <td class="text-center"><img src="<?=$list->file_path?>/<?=$list->file_name?>" style="height: 60px;"></td>
                                <td><?=$status_value?></td>
                ...
                <div style="margin:10px 0;">
                    ...
                    <div class="col-xs-6 text-right">
                        <a href="/mgr/site/popup_insert?<?=$params?>" class="btn btn-primary btn-sm" style="width:80px;">등록</a>
                    </div>
                </div>
            </div>
        </div>

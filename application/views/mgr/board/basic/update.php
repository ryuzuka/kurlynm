                ...
                <div class="box-body">
                    ...
                    <h4 class="page-header">글쓰기</h4>
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" id="name" name="name" maxlength="20" class="form-control input-sm" placeholder="이름" value="<?=$board->name?>">
                            </div>
                        </div>
                        <?php
                        if ($boardconfig->board_category) {
                        ?>
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><span style="color:#FF0000;">*</span> 카테고리</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="subject" name="subject" maxlength="100" class="form-control input-sm" placeholder="글제목" value="<?=$board->subject?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <span style="margin-right: 20px;"><?=$i+1?>. 현재파일 : <a href="<?=$image_url?>" target="_blank"><?=$list->file_name?></a></span>
                                <input type="checkbox" name="image<?=$i+1?>_delete" value="Y"> 삭제
                            ...
                            <div class="col-sm-2">
                                <select name="image_cnt" id="image_cnt" class="form-control input-sm" style="width: auto; display: inline; vertical-align: middle; margin-right: 10px;">
                                    ...
                                    ?>
                                    <option value="<?=$i?>"<?php if ($cnt_select == $i) echo " selected"; ?>><?=$i?>개</option>
                                    <?php
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <span style="margin-right: 20px;"><?=$i+1?>. 현재파일 : <a href="<?=$this->board_path?>download?board_code=<?=$boardconfig->board_code?>&file_no=<?=$list->file_no?>"><?=$list->file_name?></a></span>
                                <input type="checkbox" name="file<?=$i+1?>_delete" value="Y"> 삭제

                ...
                <div class="box-body">
                    ...
                    <h4 class="page-header">글쓰기</h4>
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" id="name" name="name" maxlength="20" class="form-control input-sm" placeholder="이름" value="<?=($this->session->userdata('AID')) ? "관리자" : $this->session->userdata('UName')?>">
                            </div>
                        </div>
                        <?php
                        if ($boardconfig->board_category) {
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="subject" name="subject" maxlength="100" class="form-control input-sm" placeholder="글제목" value="<?php if ($board) { echo "Re : ".$board->subject; } else { echo set_value('subject'); } ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="file" name="image1" class="board-image form-control input-sm" value="">
                    ...
                    <h4 class="page-header"></h4>
                        <div class="form-group text-center">
                            ...
                            <button type="button" class="btn btn-warning btn-sm" style="width:60px;" onclick="location.href='<?=$this->board_path?>?board_code=<?=$boardconfig->board_code?>';">취소</button>
                        </div>
                    </form>
                </div>
            </div>

    ...
    <form name="searchForm" method="get">
        ...
        <div class="col-xs-6 horizon-padding-none text-right">
            <select name="s_field" id="s_option" class="form-control input-sm" style="width: 100px; display: inline; vertical-align: middle;">
                <option value="subject"<?php if(isset($s_field) && $s_field == "subject") echo " selected"; ?>>제목</option>
            ...
            <button type="submit" class="btn btn-info btn-sm" style="width:60px; vertical-align: middle;">검 색</button>
        </div>
    </form>
    </div>
        ...
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body table-responsive">
                    <table class="table table-sub table-bordered responsive">
                        <colgroup>
                            ...
                            <col width="7%">
                            <?php if ($boardconfig->board_category) { ?><col width="12%"><?php } ?>
                            <col width="*">
                            <col width="12%">
                            <col width="12%">
                            <col width="7%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><span style="font-weight: bold; color: #F4543C;">공지</span></td>
                                ...
                                <td class="text-center"><?=date('F d, Y', strtotime($list->regist_date))?></td>
                ...
                <div style="margin:10px 0;">
                    ...
                    <div class="col-xs-6 horizon-padding-none text-right">
                        <a href="<?=$this->board_path?>insert?board_code=<?=$boardconfig->board_code?>" class="btn btn-primary btn-sm" style="width:70px;">글쓰기</a>
                        <?php if ($this->session->userdata('AID')) { ?><button class="btn btn-danger btn-sm btn-delete" style="width:70px;">선택삭제</button><?php } ?>
                    </div>
                </div>
            </div>
        </div>

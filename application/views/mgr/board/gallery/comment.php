                        ...
                        <ul>
                            ...
                            <li id="comment-<?=$list->c_no?>" style="padding-left: <?=$list->c_level*30?>px;">
                                ...
                                <span style="padding-left: 20px;">
                                    ...
                                    <?php } ?>
                                    <a href="javascript:void(0);" class="btn-comment-reply-form" style="color: #3C8DBC; font-size: 15px;" title="답변" data-c_no="<?=$list->c_no?>"><i class="fa fa-mail-forward reverse-vertical"></i></a>
                                </span>

        ...
        <div class="col-xs-12">
                ...
                <div class="box-body">
                    <form id="frm" name="frm" method="post" action="" onsubmit="return false;" class="form-horizontal" role="form">
                        ...
                        <div class="bg-gray clearfix" style="padding: 10px 0;">
                            <div class="col-sm-4"><?=$board->group_cd?>기<?=($board->road_part == '0') ? '' : '('.$board->road_part.'조)' ?> <?=$board->name?> (<?=$board->user_id?>)</div>
                            <div class="col-sm-8 text-right">
                                ...
                                <span><?=date('Y-m-d H:i', strtotime($board->regist_date))?></span>
                            </div>
                        </div>
                        <div class="clearfix" style="min-height: 200px; padding: 15px 0;">
                            ...
                            ?>
                            <!-- 이미지파일 -->
                            <div class="col-sm-12 board-content" style="padding-bottom: 10px;"><img src="<?=$image_url?>"></div>
                            <?php
                                }
                            }
                            ?>
            ...
            <div class="clearfix">
                ...
                <div class="col-xs-6 horizon-padding-none text-right">
                    <a href="<?=$this->board_path?>?<?=$params?>&page=<?=$page?>" class="btn btn-success btn-sm" style="width:60px;">목록</a>

                    ...
                    <table class="table table-sub table-bordered responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="vertical-align:middle;" colspan="2"><a href="<?=$this->board_path?>deleteNotice?<?=$params?>&page=<?=$page?>&seq=<?=$list->seq?>"><span style="font-weight: bold; color: #F4543C;">공지</span><i class="fa fa-minus-square"></i></a></td>
                                <?php } ?>
                            ...
                            <tr>
                                ...
                                <?php if (empty($list->road_part)) { //조정보가 없으면?> 
                                    <td class="text-center" style="vertical-align:middle;"><?=date('Y', strtotime($list->regist_date))?></td>
                                <?php } else { ?>
                                    <td class="text-center" style="vertical-align:middle;"><?=$list->road_part.'조'?></td>
                                <?php } ?>

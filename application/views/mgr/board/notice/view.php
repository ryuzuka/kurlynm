        ...
        <div class="col-xs-12">
            ...
            <div class="clearfix">
                ...
                <?php if ($this->session->userdata('ALevel') == "09" || $this->session->userdata('ALevel') == "05") { ?>
                    <?php if ($board->is_notice == "N") { ?><a href="<?=$this->board_path?>updateNotice?<?=$params?>&page=<?=$page?>&seq=<?=$board->seq?>" class="btn bg-purple btn-sm" style="width:60px;">Notice</a><?php } ?>
                <?php } ?>
                </div>
                ...
                <?php if ($this->session->userdata('ALevel') == "09" || $this->session->userdata('ALevel') == "05") { ?>
                    <?php if ($boardconfig->is_reply == "Y") { ?><a href="<?=$this->board_path?>insert?<?=$params?>&page=<?=$page?>&seq=<?=$board->seq?>" class="btn btn-primary btn-sm" style="width:60px;">Reply</a><?php } ?>

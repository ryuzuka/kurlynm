...
<section class="content">
    ...
    <div class="box" style="border-top:1px;">
                <div class="box-header with-border">
                    <div class="box-title rule-tab-menu activetab" style="margin: 0 0 0 5px !important;" onclick="javascript:location.href='total_list';">회원 목록</div>
                    <div class="box-title rule-tab-menu deactivetab" style="margin-left: -4px;" onclick="javascript:location.href='secession_list';">탈퇴회원 목록</div>
                </div>
                    ...
                    <table id="member-list" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><?php if($list->login_date) { echo date('Y-m-d', strtotime($list->login_date)); } ?></td>

...
<script type="text/javascript">
    ...
    function selected(id, name, univ_cd, univ_name, dept) {
        var member = {
            member_id: id,
            member_name: name
            //univ_cd: univ_cd,
                        ...
                        <table id="member-list" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?=$list->group_cd?></td>
                                    <td><a href="/mgr/member/update?seq=<?=$list->seq?>&<?=$params?>"><?=$list->member_id?></a></td>
                                    <td><a href="/mgr/member/update?seq=<?=$list->seq?>&<?=$params?>"><?=$list->member_name?></a></td>

                    ...
                    <td>
                        <div class="col-xs-2">
                            <select name="s_field" id="s_field" class="form-control input-sm">
                                <option value="manager_name"<?php if($s_field == "manager_name") echo " selected"; ?>>담당자 성함</option>
                                <option value="manager_tel"<?php if($s_field == "manager_tel") echo " selected"; ?>>담당자 연락처</option>
                                <option value="manager_email"<?php if($s_field == "manager_email") echo " selected"; ?>>담당자 이메일</option>
                            </select>
                        </div>
                        <div class="col-xs-4">
                    ...
                    <table id="member-list" class="table table-bordered table-hover">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">담당자 메일주소</th>
                        ...
                        <tbody>
                            ...
                            if ($estimateList) {
                                foreach($estimateList as $i => $list) {
                                    ...
                                    if($list->status == "Y") {
                                        $style_value = "font-weight: 400; cursor: pointer;";
                                        $status_value = "답변완료";
                                    } else {
                                        $style_value = "font-weight: 800; cursor: pointer;";
                                        $status_value = "답변대기";
                                    }
                            ?>
                            
                            <tr style="<?=$style_value?>" onclick="javascript:location.href='/mgr/inquiry/estimate_info?seq=<?=$list->seq?>&<?=$params?>';">
                                <td class="text-center"><?=$no;?></td>
                                <td class="text-center"><?=$list->manager_name?></td>
                                <td class="text-center"><?=$list->dec_manager_tel?></td>
                                <td class="text-center"><?=$list->dec_manager_email?></td>

...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#btn-delete').click(function () {
            ...
            if (yn) {
                $("#frm").attr("action", "/mgr/rule/private_delete");
                $('#frm').submit();
            } else {
                return false;
            }
        ...
        <div class="box">
            ...
            <form id="frm" name="frm" method="post" action="/mgr/rule/private_update" class="form-horizontal" role="form" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1">
                            <select name="is_show" id="is_show" class="form-control input-sm">
                                <option value="N" <?php if($private->is_show == "N") echo "selected"; ?>>N</option>
                                <option value="Y" <?php if($private->is_show == "Y") { echo "selected"; } ?>>Y</option>
                            </select>                            
                        </div>
                    </div>
                </div>
                ...
                <div class="box-footer text-center">
                    ...
                    <a href="/mgr/rule/private_list?<?=$params?>" class="btn btn-warning btn-sm" style="width:80px;">취소</a>

...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#btn-submit').click(function () {
            ...
            if (yn) {
                $("#frm").attr("action", "/mgr/rule/terms_insert");
                $('#frm').submit();
            } else {
                return false;
            }
        ...
        $('#btn-modify').click(function () {
            ...
            if (yn) {
                $("#frm").attr("action", "/mgr/rule/terms_update");
                $('#frm').submit();
            } else {
                return false;
            }
...
<div class="row">
        <div class="box">
            <div class="box-header with-border">
                <div class="box-title rule-tab-menu activetab" style="margin: 0 0 0 20px !important;" onclick="javascript:location.href='terms';">택배표준약관</div>
                <div class="box-title rule-tab-menu deactivetab" style="margin-left: -4px;" onclick="javascript:location.href='terms_list';">이전 약관 관리</div>
            </div>
            ...
            <?php } else { ?>
            <form id="frm" name="frm" method="post" action="/mgr/rule/terms_insert" class="form-horizontal" role="form" autocomplete="off">
                <div class="box-body">

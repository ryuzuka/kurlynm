            ...
            <div class="box">
                    ...
                    <table id="member-list" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="/mgr/rule/terms_info?seq=<?=$list->seq?>&<?=$params?>"><?=date('Y-m-d', strtotime($list->start_date))?> ~ <?=date('Y-m-d', strtotime($list->end_date))?></a></td>
                ...
                <div style="margin:10px 0;">
                    ...
                    <div class="col-xs-6 text-right">
                        <a href="/mgr/rule/terms" class="btn btn-primary btn-sm" style="width:80px;">등록</a>
                    </div>
                </div>
            </div>
    </div>

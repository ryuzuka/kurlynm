          ...
          <div class="form-box">
            ...
            <div class="form-cell">
              <div class="input-area js-input only-number">
                ...
                <div class="input">
                  <input type="text" id="company_no" name="company_no" placeholder="‘-’를 제외한 숫자만 입력해주세요." maxlength="10">
                  <button type="button" class="btn-clear"><span><span class="blind">입력 텍스트 삭제</span></span></button>
                </div>
              </div>
            </div>
            ...
            <div class="form-cell">
              <div class="input-area js-input only-number">
                ...
                <div class="input">
                  <input type="text" id="company_tel" name="company_tel" placeholder="‘-’를 제외한 숫자만 입력해주세요." maxlength="11">
                  <button type="button" class="btn-clear"><span><span class="blind">입력 텍스트 삭제</span></span></button>
                </div>
              </div>
            </div>
            ...
            <div class="pickup-details">
              ...
              <div class="form-cell">
                ...
                <div class="input-group">
                  ...
                  <div class="chk-box">
                    <input type="checkbox" id="release_method_2" name="sel_release_type" class="pickup_type" value="P"><label for="release_method_1">파레트</label>
                  </div>
                  <div class="chk-box">
                    <input type="checkbox" id="release_method_3" name="sel_release_type" class="pickup_type" value="R"><label for="release_method_1">롤테이너</label>
                  </div>
                </div>
                <div class="input-area js-input">
                  <div class="input">
          ...
          <div class="week-group">
            ...
            <div class="inbox">
              <div class="input-area js-input number">
                ...
                <div class="input">
                  <input type="text" id="early_day2_cnt" name="early_day2_cnt" title="화요일 평균 물량 건수 입력" maxlength="5">
                </div>
                건
              </div>
            </div>
            <div class="inbox">
              <div class="input-area js-input number">
                ...
                <div class="input">
                  <input type="text" id="early_day3_cnt" name="early_day3_cnt" title="수요일 평균 물량 건수 입력" maxlength="5">
                </div>
                건
              </div>
            </div>
            <div class="inbox">
              <div class="input-area js-input number">
                ...
                <div class="input">
                  <input type="text" id="early_day4_cnt" name="early_day4_cnt" title="목요일 평균 물량 건수 입력" maxlength="5">
                </div>
                건
              </div>
            </div>
            <div class="inbox">
              <div class="input-area js-input number">
                ...
                <div class="input">
                  <input type="text" id="early_day5_cnt" name="early_day5_cnt" title="금요일 평균 물량 건수 입력" maxlength="5">
                </div>
                건
              </div>
            </div>
            <div class="inbox">
              <div class="input-area js-input number">
                ...
                <div class="input">
                  <input type="text" id="early_day6_cnt" name="early_day6_cnt" title="토요일 평균 물량 건수 입력" maxlength="5">
                </div>
                건
              </div>
            </div>
            <div class="inbox">
              <div class="input-area js-input number">
                ...
                <div class="input">
                  <input type="text" id="early_day7_cnt" name="early_day7_cnt" title="일요일 평균 물량 건수 입력" maxlength="5">
                </div>
                건
              </div>
            </div>
            ...
            <div class="form-cell">
              ...
              <div class="vertical-box">
                ...
                <div class="standard-group-new">
                  <div class="input-area js-input w60 number">
                    <div class="input">
                      <input type="text" id="goods_length" name="goods_length" title="규격 가로 입력" placeholder="가로 x 세로 x 높이 (세변의 합)" maxlength="5">
                    </div>
                  </div>
                  <div class="input-area js-input w40 number">
                    <div class="input">
                      <input type="text" id="goods_weight" name="goods_weight" title="무게 입력" placeholder="무게" maxlength="4">
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="form-box">
            ...
            <div class="form-cell">
              <div class="input-area js-input">
                ...
                <div class="input">
                  <input type="text" id="manager_tel" name="manager_tel" pattern="\d*" maxlength="12" placeholder="담당자 연락처를 입력해주세요.">
                  <button type="button" class="btn-clear"><span><span class="blind">입력 텍스트 삭제</span></span></button>
                </div>
              </div>
            </div>

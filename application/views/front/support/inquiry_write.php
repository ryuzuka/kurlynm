      ...
      <div class="sub-cont-wrap">
        ...
        <div class="sub-cont">
          ...
          <div class="cont-area inquiry_2">
              <form id="frm" name="frm" method="post" action="/support/inquiry_write" class="form-horizontal" role="form" autocomplete="off" enctype="multipart/form-data">
                    <div class="cont-top">
                      <ul class="ul-table">
                        <li>
                          <dl>
                        ...
                        <li>
                          <dl>
                            ...
                            <dd><input type="text" id="question_title" name="question_title"></dd>
                          </dl>
                        </li>
                        <li>
                          <dl>
                            ...
                            <dd>
                              <div class="add-file-box">
                                ...
                                <input type="text" id="add_url" value="선택된 파일 없음" readonly>
                        ...
                        <li>
                          <dl>
                            ...
                            <dd><textarea id="question_content" name="question_content"></textarea></dd>
                          </dl>
                        </li>
                      </ul>

      ...
      <div class="mypage_adit">
        ...
        <div id="pop-secession-complete" class="layer" role="dialog" aria-modal="true">
            <div class="layer-wrap">
              ...
              <div class="button-wrap">
                <button class="btn" onclick="javascript:location.href='/';">확인</button>
              </div>
            </div>
        </div>        
              ...
              <div class="text">
                ...
                <div class="center">
                  <h3>그동안 이용해 주셔서 감사합니다.</h3>
                   <h4>고객님의 의견을 반영하여 더 나은 서비스를 제공하는 컬리넥스트마일이 되겠습니다.</h4>
                   <h4>회원 탈퇴 후 <?=$privates->join_day?>일간 재가입이 불가능합니다.</h4>
                </div>                  
              </div>
            </div>
            <div class="button-wrap">
